      ...
      <div class="cell example example3" id="example-3">
        <form method="post" action="{{url('addmoney/stripe/'.$fee)}}">
          ...
          <div class="fieldset">
            ...
            <input id="example3-zip" data-tid="elements_examples.form.postal_code_placeholder" class="field empty third-width" type="hidden" value="{{ $fee }}" name="zip">
          </div>
          <button type="submit" data-tid="elements_examples.form.pay_button">Pay {{ $fee }}</button>
