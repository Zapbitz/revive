    ...
    <div class="form-group">
        ...
        <div class="form-check form-check-radio form-check-inline">
                <label class="form-check-label">
                    <input class="form-check-input" type="radio" name="time" id="exampleRadios1" value=" {{$start_op_time}} " >
                   {{$start_op_time}}
                    <span class="circle">
        ...
        <button type="submit" class="btn btn-primary">Book an Appoinment </button>
      </form>
</div>
{{-- 
